...
void DepartureControl::initData(QString data)
{
    ...
    for(int i=0; i<list.size() - 1; i++){
        ...
        ui->tableWidget->setItem(i,0,new QTableWidgetItem(itemList[0]));
        ui->tableWidget->setItem(i,1,new QTableWidgetItem(itemList[1]));
    }
}
...
void DepartureControl::updateData(QString data)
{
    ...
    for(int i=0; i<rowCount; i++){
        if(ui->tableWidget->item(i,1)->text() == list[0]){
            ...
            ui->tableWidget->setItem(i,3,new QTableWidgetItem(list[2]));
            ui->tableWidget->setItem(i,4,new QTableWidgetItem(list[3]));
        }
